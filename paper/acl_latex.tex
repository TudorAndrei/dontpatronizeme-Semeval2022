...
% Please add proper citations to all models used CBOW or SkipGram-,

% Please add more details on the speech dataset you collected and
%the motivation behind this.

% Please add captions for results tables,
% and at least a brief discussion of the results.

% Given that in this paper there is a significant amount of work,
% results and systems compared, it would benefit the authors to provide a
% discussion section so other readers can learn from this work.
